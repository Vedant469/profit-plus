        ...
        <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto; background: #020617; color: #f8fafc; border-radius: 16px; overflow: hidden;">
          ...
          <div style="padding: 32px;">
            ...
            <div style="background: #1e293b; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
              <h2 style="color: #f59e0b; font-size: 16px; margin: 0 0 16px; text-transform: uppercase; letter-spacing: 0.1em;">Lead Details</h2>
              ...
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0;">
                    <a href="mailto:${email}" style="color: #f59e0b; font-size: 14px; font-weight: 600;">${email}</a>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0;">
                    <span style="background: #f59e0b20; color: #f59e0b; padding: 4px 12px; border-radius: 20px; font-size: 13px; font-weight: 600;">${budget || 'Not specified'}</span>
                  </td>
                </tr>
              </table>
            </div>
            ...
            <!-- Message -->
            <div style="background: #1e293b; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
              <h2 style="color: #f59e0b; font-size: 16px; margin: 0 0 12px; text-transform: uppercase; letter-spacing: 0.1em;">Their Message</h2>
              <p style="color: #94a3b8; font-size: 14px; line-height: 1.7; margin: 0;">${message}</p>
            </div>

            <!-- CTA -->
            <div style="text-align: center;">
              <a href="mailto:${email}" style="display: inline-block; background: linear-gradient(135deg, #f59e0b, #f97316); color: #020617; font-weight: 700; font-size: 15px; padding: 14px 32px; border-radius: 12px; text-decoration: none;">
                Reply to ${name} →
              </a>
            </div>
          </div>
