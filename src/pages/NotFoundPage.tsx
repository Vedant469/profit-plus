    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      ...
      >
        <div className="inline-flex items-center gap-2 mb-8">
          ...
          <span className="font-bold text-white text-xl">Profit<span className="text-emerald-400">Plus</span></span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/"
            className="group flex items-center justify-center gap-2 px-6 py-3 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold rounded-xl transition-all hover:shadow-lg hover:shadow-emerald-500/25"
          >
            Back to Home
