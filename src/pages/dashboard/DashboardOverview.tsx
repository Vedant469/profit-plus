  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400 mt-1">Welcome back, Sarah. Here's how your campaigns are performing.</p>
      </div>
      ...
      >
        ...
        <ResponsiveContainer width="100%" height={300}>
          <AreaChart data={monthlyPerformance}>
            ...
            <YAxis stroke="#6b7280" tick={{ fill: '#6b7280', fontSize: 12 }} tickFormatter={(v: number) => `$${(v / 1000).toFixed(0)}k`} />
      ...
      >
        ...
        <ResponsiveContainer width="100%" height={280}>
          <BarChart data={channelBreakdown}>
            <CartesianGrid strokeDasharray="3 3" stroke="#ffffff08" />
            <XAxis dataKey="channel" stroke="#6b7280" tick={{ fill: '#6b7280', fontSize: 11 }} />
            <YAxis stroke="#6b7280" tick={{ fill: '#6b7280', fontSize: 12 }} />
            <Tooltip contentStyle={{ backgroundColor: '#1e293b', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '12px', color: '#f8fafc' }} />
            <Legend wrapperStyle={{ color: '#9ca3af', fontSize: '12px' }} />
            <Bar dataKey="roas" name="ROAS" fill="#3b82f6" radius={[6, 6, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'Total Impressions', value: '24.8M', icon: Target, color: 'text-blue-400' },
            ...
            { label: 'Avg. CPC', value: '$1.21', icon: DollarSign, color: 'text-amber-400' },
