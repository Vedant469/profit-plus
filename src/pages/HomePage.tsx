...
const phrases = [
  ...
  'Find the Channel That Actually Converts',
  'Turn Acquisition Data Into Decisions',
...
const stageCards = [
  {
    ...
    title: 'Diagnose',
    description:
      'Map the funnel, offer, tracking, audience, and unit economics before increasing spend.',
  },
  {
    number: '02',
    title: 'Test',
    description:
      'Run focused channel, creative, landing-page, and messaging experiments with a clear hypothesis.',
  },
  {
    number: '03',
    title: 'Learn',
    description:
      'Compare results against the same decision framework so the team knows what to keep, pause, or change.',
  },
  {
    number: '04',
    title: 'Scale',
    description:
      'Increase investment only after the funnel shows enough evidence of repeatable economics.',
  },
]
...
const pricing = [
  {
    ...
    period: '/month',
    description:
      'For startups testing their first credible acquisition channel.',
    features: [
  ...
  },
  {
    ...
    period: '/month',
    description:
      'For teams with early traction that need a more repeatable growth system.',
    features: [
  ...
  },
  {
    ...
    period: '/month',
    description:
      'For teams ready to expand a channel without losing sight of payback and margin.',
    features: [
...
function TypewriterText() {
      ...
      if (timestamp - state.lastUpdate >= interval) {
        ...
        if (state.deleting) {
          if (state.charIndex > 0) {
            state.charIndex -= 1
            setDisplayText(
              phrase.slice(0, state.charIndex)
            )
          } else {
  ...
  return (
    <>
      ...
      {/* Independent emerald typewriter cursor */}
      <span
  ...
  useEffect(() => {
    ...
    const animate = (timestamp: number) => {
      ...
      const progress = Math.min(
        (timestamp - startRef.current) / 1400,
        1
      )
...
export default function HomePage() {
  ...
  const frameworkInView = useInView(frameworkRef, {
    once: true,
    margin: '-80px',
  })
  ...
  return (
    <div className="bg-slate-950 text-white">
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 pb-36 pt-24 sm:px-6 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <motion.p
              ...
              className="mx-auto mb-10 max-w-3xl text-lg leading-relaxed text-gray-300 sm:text-xl"
            >
              We help startups test acquisition channels,
              improve the funnel, and build a repeatable path
              from first click to revenue — without
              pretending every experiment is a win.
            </motion.p>
            ...
            >
              <MagneticButton>
                <Link
                  to="/contact"
                  className="neon-btn group flex min-w-[210px] items-center justify-center gap-2 rounded-xl bg-emerald-500 px-6 py-3.5 font-bold text-slate-950 transition-all duration-200 hover:bg-emerald-400"
              ...
              <MagneticButton>
                <Link
                  to="/services"
                  className="flex min-w-[210px] items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-6 py-3.5 font-semibold text-white transition-all duration-200 hover:border-emerald-500/30 hover:bg-white/10"
            ...
            >
              {[
                {
                  value: '1',
                  label: 'Clear growth goal',
                },
                {
                  value: '1–2',
                  label: 'Channels to test',
                },
                {
                  value: '60–90d',
                  label: 'Focused learning window',
                },
              ].map((item) => (
                <div
                  key={item.label}
      ...
      <section
        ref={statsRef}
        className="border-b border-white/5 bg-slate-950 py-16 md:py-20"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 max-w-2xl">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-white md:text-4xl">
              Focused growth beats scattered activity.
            </h2>

            <p className="mt-4 text-gray-400">
              The framework is designed to help a small startup
              team make better acquisition decisions with limited
      ...
      <section
        id="services"
        className="border-b border-white/5 bg-slate-900/30 py-20 md:py-28"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 flex flex-col justify-between gap-5 md:flex-row md:items-end">
            <div className="max-w-3xl">
              ...
              <h2 className="text-3xl font-bold tracking-tight text-white md:text-5xl">
                Everything around the acquisition problem.
              </h2>

              <p className="mt-4 max-w-2xl text-gray-400">
                Strategy, execution, measurement, and iteration
                in one operating loop.
              </p>
            </div>

            <Link
              to="/services"
              className="inline-flex items-center justify-center gap-2 text-sm font-semibold text-emerald-300 hover:text-emerald-200"
            >
              Explore services
          ...
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-gray-400">
                Every engagement is built around a simple loop:
                diagnose the constraint, run a focused experiment,
                record what happened, then decide what deserves
                more budget.
              </p>
      ...
      <section
        id="portfolio"
        className="border-y border-white/5 bg-slate-900/30 py-20 md:py-28"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-gray-400">
                These are illustrative scenarios, not client claims.
                They show the type of problem, experiment, and decision
                the Profit Plus framework is designed to handle.
              </p>
            </div>
      ...
      <section className="bg-slate-950 py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 max-w-3xl">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-white md:text-5xl">
              A dashboard built around decisions, not vanity metrics.
            </h2>

            <p className="mt-4 text-gray-400">
              The demo dataset below is illustrative. The important
              part is the reporting model: spend, conversion, revenue,
              and channel economics in one place.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
            <div className="rounded-3xl border border-white/5 bg-slate-900/80 p-5 md:p-6">
              <div className="mb-5 flex items-center justify-between">
                ...
                <div className="rounded-full border border-emerald-400/15 bg-emerald-400/10 px-3 py-1 text-xs text-emerald-300">
                  Demo
                </div>
              </div>
      ...
      <section className="border-y border-white/5 bg-slate-900/30 py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 max-w-3xl">
            ...
            <p className="mt-4 text-gray-400">
              Use the existing ROI calculator as a planning
              exercise — not as a promise of future performance.
            </p>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <p className="mt-4 text-gray-400">
              Management fees are separate from media spend. We
              would rather recommend the smallest useful engagement
              than sell you a giant retainer.
            </p>
          </div>
          ...
          <p className="mx-auto mt-6 max-w-3xl text-center text-xs leading-5 text-gray-600">
            Not a fit yet? We generally do not recommend paid
            acquisition for pre-revenue teams without a validated
            offer or enough budget to run meaningful experiments.
          </p>
        </div>
      </section>
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.75fr_1.25fr] lg:px-8">
          <div>
            ...
            <h2 className="text-3xl font-bold tracking-tight text-white md:text-5xl">
              No promises we cannot prove.
            </h2>

            <p className="mt-4 max-w-md text-gray-400">
              Here is how we think about budget, timelines, fit,
              and risk before an engagement starts.
            </p>
                ...
                <div key={faq.q}>
                  ...
                  <AnimatePresence initial={false}>
                    {open && (
                      ...
                      >
                        <p className="px-5 pb-5 text-sm leading-6 text-gray-400 md:px-6 md:pb-6">
                          {faq.a}
                        </p>
                      </motion.div>
                    )}
      ...
      <section className="relative overflow-hidden bg-emerald-400 py-16 md:py-20">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 px-4 sm:px-6 md:flex-row md:items-center lg:px-8">
          <div className="max-w-2xl">
            <p className="text-sm font-bold uppercase tracking-[0.22em] text-slate-950/70">
              Ready to test the next growth lever?
            </p>

            <h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-950 md:text-5xl">
              Bring us the funnel. We’ll bring the experiments.
            </h2>
          </div>
...
<section className="border-t border-white/5 bg-slate-950 py-16 md:py-20">
  <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
    <div className="mx-auto inline-flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-white">
      <Github className="h-7 w-7" />
    </div>

    <p className="mt-5 text-sm font-semibold uppercase tracking-[0.22em] text-emerald-400">
      Open Source Project
    </p>

    <h2 className="mt-3 text-3xl font-bold tracking-tight text-white md:text-4xl">
      Built in public. See how Profit Plus works.
    </h2>

    <p className="mx-auto mt-4 max-w-2xl text-gray-400">
      Explore the codebase, product architecture, dashboard,
      growth tooling, and the systems behind this project.
    </p>
    ...
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="group mt-8 inline-flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-5 py-3.5 text-sm font-semibold text-white transition-all hover:border-emerald-400/30 hover:bg-emerald-400/10 hover:text-emerald-300"
    >
      <Github className="h-5 w-5" />

      <span>View Profit Plus on GitHub</span>
