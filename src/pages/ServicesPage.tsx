    ...
    <div className="bg-slate-950 pt-24">
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            <p className="text-amber-400 font-medium mb-3">What We Offer</p>
          ...
          {services.map((service, i) => {
            ...
            return (
              <motion.div
                ...
                className={`flex flex-col ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'} gap-6 md:gap-8 p-6 md:p-8 bg-slate-900 border border-white/5 rounded-2xl hover:border-amber-500/10 transition-all`}
              >
                ...
                <div className="flex-shrink-0 flex items-center">
                  <Link
                    to="/contact"
                    className="group flex items-center gap-2 px-5 py-2.5 bg-white/5 hover:bg-amber-500 border border-white/10 hover:border-amber-500 text-gray-300 hover:text-slate-950 text-sm font-bold rounded-xl transition-all duration-200 whitespace-nowrap"
                  >
                    Get Started
      ...
      <section className="py-16 md:py-24 bg-slate-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            <p className="text-amber-400 font-medium mb-3">Why ProfitPlus</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="p-6 bg-slate-900 border border-white/5 rounded-2xl text-center hover:border-amber-500/10 transition-all"
              >
                <div className="w-10 h-10 bg-amber-500/10 border border-amber-500/20 rounded-xl flex items-center justify-center mx-auto mb-4">
