      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
              ...
              >
                ...
                {isActive(link.href) && (
                  <>
                    <motion.div
                      layoutId="activeNav"
                      className="absolute bottom-0 left-2 right-2 h-0.5 bg-gradient-to-r from-emerald-400 to-orange-500 rounded-full"
                      transition={{ type: 'spring', stiffness: 380, damping: 30 }}
                    />
                    <div className="absolute bottom-0 left-2 right-2 h-0.5 bg-emerald-400 blur-sm opacity-80 rounded-full" />
                  </>
                )}
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link
              to="/contact"
              className="flex items-center gap-1.5 px-4 py-2 bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-sm font-bold rounded-lg transition-all hover:shadow-lg hover:shadow-emerald-500/25"
            >
          ...
          >
            <div className="flex flex-col gap-1">
              ...
              <div className="pt-4 mt-2 border-t border-white/10 flex flex-col gap-3">
                ...
                <Link
                  to="/contact"
                  className="px-4 py-3 bg-emerald-500 text-slate-950 text-sm font-bold rounded-lg text-center"
                >
                  Get Started
                </Link>
              </div>
